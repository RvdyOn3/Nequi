...
public class SucursalController {
    ...
    @PostMapping
    public Mono<ResponseEntity<SucursalResponseDto>> createSucursal(@Valid @RequestBody SucursalRequestDto sucursalRequestDto) {
        return sucursalHandler.addSucursal(sucursalRequestDto).map(ResponseEntity::ok);
    }
}
